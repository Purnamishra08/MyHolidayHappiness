                                            ...
                                            <div class="row">
										 		<div class="col-md-6">
													<div class="form-group">
														...
														<input type="text" class="form-control" placeholder="Enter place Name" name="place_name" id="place_name" value="<?php echo set_value('place_name'); ?>">
													</div> 
                                                </div>	
												...
												<div class="col-md-6"> 
                                                    ...
                                                    <input type="text" class="form-control" readonly placeholder="Enter place url" name="place_url" id="place_url" value="<?php echo set_value('place_url'); ?>">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6"> 
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Enter Alt tag for place image" name="alttag_thumb" id="alttag_thumb" value="<?php echo set_value('alttag_thumb'); ?>" maxlength="60">
                                                    </div>
                                                </div>
                                                <div class="clearfix"></div>
												...
												<div class="col-md-6"> 
													<div class="form-group">
														...
														<input type="text" class="form-control" placeholder="Place Latitude" name="latitude" id="latitude" value="<?php echo set_value('latitude'); ?>" >
													</div>
												</div>
												...
												<div class="col-md-6"> 
													<div class="form-group">
														...
														<input type="text" class="form-control" placeholder="Place Longitude" name="longitude" id="longitude" value="<?php echo set_value('longitude'); ?>" >
													</div>
												</div>
                                            ...
                                            <div class="row">                                                  
                                                <div class="col-md-6"> 
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="2-3 Hours" name="trip_duration" id="trip_duration" value="<?php echo set_value('trip_duration'); ?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-6"> 
                                                    <div class="form-group">
										      ...
										      <h3>Package Meta Tags</h3>
												<div class="row">  
													...
													<div class="col-md-6"> 
														<div class="form-group">
														<label>Meta Keywords</label>
														<textarea name="pckg_meta_keywords" id="pckg_meta_keywords"  placeholder="Meta Keywords..." class="form-control textarea1"></textarea>
													</div>
													</div>
