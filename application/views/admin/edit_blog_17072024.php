                                        ...
                                        <div class="box-main">
                                            ...
                                            <div class="row">
                                               ...
                                               <div class="col-md-6">
                                                ...
                                                <input name="show_comments" id="show_comments" value="1" type="checkbox" <? if($show_comments=='1') {?> checked="" <? }?>  >
                                                    ...
                                                    <div class="col-md-6">
														...
														<input name="show_home" id="show_home" value="1" type="checkbox" <? if($show_in_home=='1') {?> checked="" <? }?>  >
                                                        </div>
													</div>                                               
                                                </div>                                               
