...
<?php
foreach ($countrynmm as $rows)
{
    
    $countryid = $rows['countryid'];
    $continent_id = $rows['continent_id'];
                            ...
                            <div class="panel panel-bd lobidrag">
                                ...
                                <div class="panel-body">
									...
									<?php echo form_open('', array( 'id' => 'form_country', 'name' => 'form_country', 'class' => 'add-user'));?>
                                        <div class="row">
                                            <div class="col-md-6"> 
                                                <div class="form-group">
                                                    <label> Country </label>
                                                    <input type="text" class="form-control fld" placeholder="Enter Country" name="country_name" id="country_name" value="<?php echo set_value('country_name' ,$country_name); ?>">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <button type="button" class="blackbtn" onClick="window.location='<?php echo base_url(); ?>admin/country'">Back</button> 
