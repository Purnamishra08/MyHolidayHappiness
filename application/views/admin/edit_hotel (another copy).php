                                              ...
                                              <div class="col-md-12">                                                 
                                                 ...
                                                 <!--  <div class="option-name" id="optnshwhd">
                                                        <table class="table border-none" id="addRowTable">
                                                            ...
                                                            if (!empty($edit_assciated_data)) {
                                                              foreach ($edit_assciated_data as $rowss1) {
                                                                
                                                                $tour_pack_id = $rowss1['tour_pack_id'];
                                                                $destination_id = $rowss1['destination_id'];
                                                                $no_ofdays = $rowss1['no_ofdays'];
                                                                $no_ofnight = $rowss1['no_ofnight'];?>
                                                                                              <tr>
                                                                                                  <td>
                                                                     <div class="col-md-5">
                                                                        <select class="form-control"  id="destination_id"  name="destination_id[]" >
                                                                         ...
                                                                         <?php  echo $this->Common_model->populate_select($dispid = $destination_id, "destination_id", "destination_name", "tbl_destination", "", "destination_name asc", ""); ?>
                                                                           ...
                                                                           <option value=''>-- Select Days --</option>
                                                                             <?php  echo $this->Common_model->populate_select($dispid = $no_ofdays, "durationid", "no_ofdays", "tbl_package_duration", "", "no_ofdays asc", ""); ?>
                                                                         </select>    
                                                                                                         </div>
                                                                           ...
                                                                           <option value=''>-- Select Nights --</option>
                                                                             <?php  echo $this->Common_model->populate_select($dispid = $no_ofnight, "durationid", "no_ofnights", "tbl_package_duration", "", "no_ofnights asc", ""); ?>
                                                                         </select> 
                                                                                                          </div>  
                                                                                                  </td>
                                                                                                  <td> 
