                        ...
                        <div class="col-md-12">
                            <div class="panel panel-bd lobidrag">
                                ...
                                <div class="panel-body">
                                    <?php echo $message; ?>
									<?php echo form_open('', array( 'id' => 'form_editvehicle', 'name' => 'form_editvehicle', 'class' => 'add-user'));?>
                                        <div class="row">
                                        ...
                                        <button type="button" class="blackbtn" onClick="window.location='<?php echo base_url(); ?>admin/vehicletype'">Back</button> 
