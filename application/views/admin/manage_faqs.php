						...
						<div class="panel panel-bd lobidrag">
							...
							<div class="panel-body">
								...
								<div class="table-responsive">
									<table id="datatable" data-toggle="table" class="table table-bordered table-striped table-hover" data-url="<?php echo base_url(); ?>admin/faqs/datatable" data-edit-url="<?php echo base_url(); ?>admin/faqs/edit/ID" data-delete-url="<?php echo base_url(); ?>admin/faqs/delete/ID">
										<thead>
											<tr class="info">
												<th>Sl #</th>
												<th>Questions</th>
		...
		<script type="text/javascript">
			$(document).on('click', '.status', function() {
				if (confirm('Are you sure to change the status?')) {
					...
					$.ajax({
						url: "<?php echo base_url(); ?>admin/faqs/changestatus/" + id,
						type: 'post',
						data: {
