...
<html lang="en">
                        ...
                        <div class="col-sm-4">
                            <div  style="margin-bottom: 25px;box-shadow: 0 3px 6px rgba(0, 0, 0, 0.16);
                                ...
                                <!-- <form name="colour" id="colour" method="post"> -->
                                   ...
                                   <?php echo form_open('', array( 'id' => 'form_menutags', 'name' => 'form_menutags'));?>
                                    <?php echo $messageadd; ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control fld" name="catId" id="catId">
                                    ...
                                    <div class="form-group">
                                        <label> Tag </label>
                                        <input type="text" class="form-control fld" placeholder="Enter tag" name="tag_name" id="tag_name" value="<?php echo set_value('tag_name'); ?>">  
                                    </div>

                                    <div id="abouttour" style="display: none;">
                                    <div class="form-group">
                                        <label> About tour package </label>                                       
                                         <textarea cols="" rows="2" placeholder="About tour package" class="form-control textarea1" name="about_tour" id="about_tour"></textarea>
                                    </div>
                                    </div>
                                            ...
                                            <table id="example1" class="table table-bordered table-striped table-hover">
                                                ...
                                                <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="javascript:void(0);" data-id="<?php echo $tagid ; ?>" data-toggle="modal" data-target="#myModal" class="btn btn-primary btn-sm edit" title="Edit"><i class="fa fa-pencil"></i></a>
    ...
    $(document).on('click', '.edit', function () {
        ...
        var val = $(this).data("id");
        $.ajax({
            url: "<?php echo base_url(); ?>admin/menutags/menutageditpopup/" + val,
            type: 'post',
            data: {'<?php echo $this->security->get_csrf_token_name(); ?>' : '<?php echo $this->security->get_csrf_hash(); ?>'},
            cache: false,
            //processData: false,
