...
<html lang="en">
            ...
            <div class="content-wrapper">
                <section class="content-header">
                    ...
                    <div class="header-title">
                        ...
                        <small> Manage package duration </small>
                    </div>
                </section>
                <!-- Main content -->
                        ...
                        <div class="col-sm-4">
                            <div  style="margin-bottom: 25px;box-shadow: 0 3px 6px rgba(0, 0, 0, 0.16);
                                  background-color:#fff; padding:25px;border-radius: 4px;">
                                   ...
                                   <?php echo form_open('', array( 'id' => 'form_pduration', 'name' => 'form_pduration'));?>
                                    <?php echo $messageadd; ?>
                                    	
                                    <div class="form-group">
                                    	 <label> Duration Name </label>
                                                <input type="text" class="form-control fld" placeholder="Enter duration name" name="duration_name" id="duration_name" value="<?php echo set_value('duration_name'); ?>">  
                                    </div>
                                     
                                    <div class="form-group">
                                        <label> No of Days  </label>
                                        <input type="text" class="form-control fld" placeholder="Enter no of days" name="no_ofdays" id="no_ofdays" value="<?php echo set_value('no_ofdays'); ?>">  
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control fld" placeholder="Enter no of nights" name="no_ofnights" id="no_ofnights" value="<?php echo set_value('no_ofnights'); ?>">  

                                    </div>
                                    <div class="clearfix"></div>
                                    
                                    <div class="reset-button">  
                                        <button type="submit" class="btn redbtn" name="btnSubmitpduration" id="btnSubmitvehicleprice">Save</button>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="table-responsive">
                                            <table id="example1" class="table table-bordered table-striped table-hover">
                                                ...
                                                <tr>
                                                        <td><?php echo $cnt; ?></td>                                                       
                                                        <td><?php echo $duration_name; ?></td>                                                      
                                                        <td><?php echo $no_ofdays.' Days'; ?></td>
                                                        <td><?php echo $rows['no_ofnights'].' Nights'; ?></td>
	                                                    <td>				                                        
			                                            <?php if($status==1) { ?>
			                                                <span class="status" data-id="<?php echo "status-".$durationid; ?>"><a href="javascript:void(0)" title="Status is active. Click here to make it inactive."><span class="label-custom label label-success">Active</span></a></span>
			                                            <?php } else { ?>
			                                            <span class="status" data-id="<?php echo "status-".$durationid; ?>"><a href="javascript:void(0)" title="Status is inactive. Click here to make it active."><span class="label-custom label label-danger">Inactive</span></a></span>
			                                             <?php } ?>
				                                        </td>
	                                                    <td>
															
															<a href="javascript:void(0);" data-id="<?php echo $durationid; ?>" data-toggle="modal" data-target="#myModal" class="btn btn-primary btn-sm edit" title="Edit"><i class="fa fa-pencil"></i></a>
															...
															<a onClick="return confirm('Are you sure to delete this?')" href="<?php echo base_url().'admin/package-duration/delete/'.$durationid; ?>" class="btn btn-danger btn-sm" title=""><i class="fa fa-trash-o"></i> </a>
														</td>
                                                </tr>
  ...
  $(document).on('click', '.status', function(){
				if(confirm('Are you sure to change the status?'))
				{
					...
					$.ajax({
						url: "<?php echo base_url(); ?>admin/package_duration/changestatus/"+id,
						type: 'post',
                ...
                $(document).on('click', '.edit', function () {
                    ...
                    $.ajax({
                        url: "<?php echo base_url(); ?>admin/package_duration/vpriceeditpopup/" + val,
                        type: 'post',
                        data: {'<?php echo $this->security->get_csrf_token_name(); ?>' : '<?php echo $this->security->get_csrf_hash(); ?>'},
                        cache: false,
                        //processData: false,
