...
<html>
    ...
    <body>
        ...
        <div class="container  ">
            ...
            <div class="about-content-text about-hiring-content">
                <?php
					$hiring=$this->Common_model->showname_fromid("page_content","tbl_contents","content_id='8'");
					echo $hiring; 
				?> 
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 text-center ">
                        <h3 style="font-size: 24px;">Didn't find an answer to your question?</h3>
                        ...
                        <div class="modal-body">
							...
							<?php echo form_open(base_url('contactus'), array( 'id' => 'form_contact', 'name' => 'form_contact'));?>
								<div class="row">
									...
									<div class="col-md-4">
										<input type="hidden" name="pagename" id="pagename" value="Hiring Page">
