...
<html>
    ...
    <body>
		...
		<?php		
			$dataPlaces = $this->Common_model->get_records("placeimg,place_name,alttag_banner","tbl_places","placeid=$placeid");
			$placeimg = $dataPlaces[0]['placeimg'];	
			$placealttag_banner = $dataPlaces[0]['alttag_banner'];		
			if(file_exists("./uploads/".$placeimg) && ($placeimg!='')) {
				$place_banner_img = base_url()."uploads/".$placeimg;
			}
			else 
				$place_banner_img = base_url()."assets/images/golden-triangel-banner.jpg";
		?>
            <img src="<?php echo $place_banner_img; ?>" class="img-fluid" alt="<?php echo (!empty($placealttag_banner)) ? $placealttag_banner : $dataPlaces[0]['place_name']; ?>">
						...
						<div class="row">
							...
							<div class="col-lg-6">
								<div class="inner-topsearch-box text-center">
									<h2>
										<?php echo $dataPlaces[0]['place_name']; ?> 
									</h2>
								</div>
							</div>
							<div class="col-lg-3"></div>
        ...
        <section class="touristlist">
            <div class="container   mb60">
                  ...
                  <li><a href="#"><?php echo $dataPlaces[0]['place_name']; ?> Tour Packages</a></li>
                </ul>
                <div class="row">
                    <div class="col-md-7 mb-4">
                        <h1><?php echo count($place_tour_packages); ?> <?php echo $dataPlaces[0]['place_name']; ?> Tour Packages Found.</h1>
                    </div>
				...
				<div class="row" id="search_result">	
					<div id="loader"></div>
					<?php
						if(!empty($place_tour_packages)){
						foreach ($place_tour_packages as $tour_package)
						{
