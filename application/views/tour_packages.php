            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <div class="inner-topsearch-box text-center">
                        <h4>Explore best Tour Packages</h4>                 
                        <form class="inner-tourist-banner-form"><input type="text" class="form-control" placeholder="Enter destinations for tour packages" value=""></form>
                    </div>
                </div>
                <div class="col-lg-2"></div>
        ...
        <section class="bg01">
            <div class="container">
                <div class="row">
                    ...
                    <?php
                    if (!empty($allTpackages)) {
                        foreach ($allTpackages as $allTpackage) {
