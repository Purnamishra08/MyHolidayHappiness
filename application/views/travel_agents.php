    ...
    <body>
        ...
        <div class="container  ">
            ...
            <div class="about-content-text">
                <?php
					$travel_agent=$this->Common_model->showname_fromid("page_content","tbl_contents","content_id='9'");
					echo $travel_agent; 
				?> 
                        ...
                        <div class="modal-body">
							...
							<?php echo form_open(base_url('contactus'), array( 'id' => 'form_contact', 'name' => 'form_contact'));?>
								<div class="row">
									...
									<div class="col-md-4">
										<input type="hidden" name="pagename" id="pagename" value="Travel Agent Page">
