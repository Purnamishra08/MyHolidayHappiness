...
@section('content')
 ...
 <!-- start banner slider  -->
    <div class="srvbanner clearfix" style="background-repeat: no-repeat; background-position: center top; background-image: url('{{ asset("img/contact-us.jpg") }}'); background-size: cover;"></div>
    <!-- end banner slider  -->
    ...
    <section class="contact-section" id="contact">
        <div class="container">
            ...
            <p class="desc text-center mb-5 pb-4 js-scroll fade-in" >We would love to hear from you. Whether you have a question, a comment, a feedback, or a request, we are here to help. You can reach us by phone, email, or online. You can also visit us at our center during our business hours.</p>
